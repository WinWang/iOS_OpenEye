...
enum RoutePath {
    ...
    // 专题详情页面
    private static let topicDetailListPath = "openEye://topicDetail/"
    ...
    var path: String {
        ...
        case .topicDetail(let id):
            return Self.topicDetailListPath + "\(id)"
        }
    }
    ...
    // 专题详情
    static var topicDetailPattern: String {
        return topicDetailListPath + "<int:id>"
    }
}
